...
export function ProgressBar({
  ...
  return (
    <div className="sticky top-0 z-10 border-b border-hairline/50 bg-canvas/90 px-6 pt-6 pb-4 backdrop-blur-md md:px-12">
      <div className="mx-auto w-full max-w-[760px]">
        <div className="flex items-center justify-between text-[11px] font-medium uppercase tracking-[0.1em] text-ink-subtle">
