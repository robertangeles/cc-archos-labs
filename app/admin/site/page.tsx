      ...
      <section className="mx-auto w-full max-w-[760px] px-6 pt-24 pb-32 md:px-12">
        <div className="flex items-center justify-between gap-x-4">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-semibold leading-[1.1] tracking-[-0.02em] text-fg md:text-[40px]">
              SEO &amp; brand.
            </h1>
          </div>
          <button
        ...
        <p className="mt-6 max-w-[600px] text-base leading-[1.7] text-muted">
        ...
        {load.kind === "loading" ? (
          ...
          <form onSubmit={onSubmit} className="mt-12 flex flex-col gap-y-6">
            {fieldDefs.map((field) => (
              <label key={field.key} className="flex flex-col gap-y-2">
